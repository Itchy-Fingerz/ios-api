...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="WrldUtils",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
/// A button that changes background color when it is highlighted.
SWIFT_CLASS("_TtC9WrldUtils30WRLDUtilsBackgroundColorButton")
@interface WRLDUtilsBackgroundColorButton : UIButton
/// The normal background color.
@property (nonatomic, strong) UIColor * _Nullable normalColor;
/// The background color for when button is highlighted.
...
SWIFT_CLASS("_TtC9WrldUtils20WRLDUtilsImageButton")
@interface WRLDUtilsImageButton : UIButton
...
@property (nonatomic, copy) NSString * _Nullable downImageName;
...
SWIFT_CLASS("_TtC9WrldUtils18WRLDUtilsImageView")
@interface WRLDUtilsImageView : UIImageView
...
SWIFT_CLASS("_TtC9WrldUtils18WRLDUtilsTextField")
@interface WRLDUtilsTextField : UITextField
/// The identifier of the bundle to load the images from, for example this framework would be
/// ‘com.wrld.WrldUtils’.
@property (nonatomic, copy) NSString * _Nullable bundleID;
...
@property (nonatomic, copy) NSString * _Nullable leftDownName;
...
@property (nonatomic, copy) NSString * _Nullable rightImageName;
/// The name of the image to use for the right icon when the button is in the highlighted state.
@property (nonatomic, copy) NSString * _Nullable rightDownName;
...
SWIFT_PROTOCOL("_TtP9WrldUtils26WRLDUtilsTextFieldDelegate_")
@protocol WRLDUtilsTextFieldDelegate
@optional
...
SWIFT_CLASS("_TtC9WrldUtils21WRLDUtilsToggleButton")
@interface WRLDUtilsToggleButton : UIButton
/// The identifier of the bundle to load the images from, for example this framework would be
/// ‘com.wrld.WrldUtils’.
@property (nonatomic, copy) NSString * _Nullable bundleID;
/// The name of the image to use when the toggle button is in the on state.
@property (nonatomic, copy) NSString * _Nullable onImageName;
/// The name of the image to use when the toggle button is in the on state and down.
@property (nonatomic, copy) NSString * _Nullable onDownName;
/// The name of the image to use when the toggle button is in the off state.
@property (nonatomic, copy) NSString * _Nullable offImageName;
/// The name of the image to use when the toggle button is in the off state and down.
@property (nonatomic, copy) NSString * _Nullable offDownName;
