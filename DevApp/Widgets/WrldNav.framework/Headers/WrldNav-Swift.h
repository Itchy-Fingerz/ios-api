...
- (nonnull instancetype)initWithName:(NSString * _Nonnull)name_ icon:(NSString * _Nonnull)icon_ instruction:(NSString * _Nonnull)instruction_ thenInstruction:(NSString * _Nonnull)thenInstruction_ path:(NSArray<NSValue *> * _Nonnull)path_ indoorID:(NSString * _Nullable)indoorID_ floorID:(NSInteger)floorID_ isMultiFloor:(BOOL)isMultiFloor_ isUsingPlaceHolders:(BOOL)isUsingPlaceHolders_ nextIndoorMapFloorName:(NSString * _Nullable)nextIndoorMapFloorName_ nextIndoorMapFloorID:(NSInteger)nextIndoorMapFloorID_ OBJC_DESIGNATED_INITIALIZER;
...
@property (nonatomic, copy) NSString * _Nonnull thenInstruction;
...
typedef SWIFT_ENUM(NSInteger, WRLDNavEvent, closed) {
...
typedef SWIFT_ENUM(NSInteger, WRLDNavMode, closed) {
...
@property (nonatomic) BOOL showRoutingPopUp;
...
SWIFT_CLASS("_TtC7WrldNav16WRLDNavPopUpView")
@interface WRLDNavPopUpView : UIView
- (nonnull instancetype)initWithFrame:(CGRect)frame OBJC_DESIGNATED_INITIALIZER;
